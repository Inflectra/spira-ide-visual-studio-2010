...
namespace Inflectra.SpiraTest.IDEIntegration.VisualStudio2010.Forms
{
	...
	public partial class frmDetailsIncident : UserControl
	{
		...
		private bool save_CheckFieldValues()
		{
			//TODO: Can this be rewritten using the Worflow variable? 
			// (Loop through, and check each field that is listed, instead of checking each field's label?)
