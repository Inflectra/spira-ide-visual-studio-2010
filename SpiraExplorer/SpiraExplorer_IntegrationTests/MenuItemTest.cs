...
namespace SpiraExplorer_IntegrationTests
{
	...
	public class MenuItemTest
	{
		...
		public void LaunchCommand()
		{
			...
			{
				CommandID menuItemCmd = new CommandID(Inflectra.SpiraExplorer.GuidList.guidSpiraExplorerCmdSet, (int)Inflectra.SpiraExplorer.PkgCmdIDList.cmdViewToolWindow);

				// Create the DialogBoxListener Thread.
				string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "SpiraExplorer", "Inflectra.SpiraExplorer.SpiraExplorerPackage");
